  ...
  return (
    <nav className="mt-8 flex items-center justify-center gap-2" aria-label="Pagination">
      <Link
        ...
        className="rounded-lg border border-line bg-card px-4 py-2 text-sm font-medium text-fg shadow-card transition hover:bg-bgSoft data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-40"
